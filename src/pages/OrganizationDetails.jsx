...
function OrganizationDetails() {
	...
	const impact = Array.isArray(organization.impact)
		? organization.impact
		: []
						...
						<div>
									...
									<div className="overflow-hidden rounded-2xl">
										{image ? (
											...
											<div className="flex h-[220px] items-center justify-center bg-[#e8f5ed]">
												<span className="text-sm font-semibold text-[#23945c]">
													No image available
												</span>
											</div>
										)}
							...
							<div className="mt-7 rounded-3xl bg-white p-7 shadow-sm ring-1 ring-black/5 sm:p-10">
								...
								{impact.length > 0 ? (
									...
									<p className="mt-6 text-base leading-7 text-gray-500">
										This organization is working to create
										positive environmental change together
							...
							<div className="mt-7 rounded-3xl bg-white p-7 shadow-sm ring-1 ring-black/5 sm:p-10">
								...
								<div className="mt-4 flex items-center gap-3">
									<div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#e1f3e8]">
										<MapPin
						...
						<aside className="lg:sticky lg:top-8 lg:h-fit">
							...
							<div className="rounded-3xl bg-white p-7 shadow-lg ring-1 ring-black/5">
								...
								<div className="mt-5 h-3 overflow-hidden rounded-full bg-gray-100">
									<div
										className="h-full rounded-full bg-[#28a66a] transition-all duration-700"
										style={{
											width: `${percentage}%`,
										}}
									/>
