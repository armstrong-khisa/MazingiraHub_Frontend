  ...
  return (
    <section className="auth-page">
      <form className="form-card auth-card" onSubmit={submit}>
        ...
        <p>Continue supporting the work that matters to you.</p>
        ...
        <button className="button" disabled={submitting}>{submitting ? 'Logging in...' : 'Log in'}</button>
        <p className="form-footer">New to MazingiraHub? <a href="/register">Create an account</a></p>
      </form>
    </section>
  )
}
